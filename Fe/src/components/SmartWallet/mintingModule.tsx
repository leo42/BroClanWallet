...
class Minting extends React.Component<MintingProps> {
  ...
  state = {
    ...
    try{      
        ...
        const policyId = lucid.utils.mintingPolicyToId(this.mintingRawScript as MintingPolicy)
        ...
        paymentTx.payToAddress(this.paymentAddress, { lovelace: BigInt(adminDatum.mintAmount) });
        const assets : Assets = {}
      ...
      const redeemer = Data.void();
        const tx = lucid.newTx()
                   ...
                   .attachMintingPolicy(this.mintingRawScript as MintingPolicy)
                   .readFrom([adminUtxo])
                   .compose(paymentTx)
