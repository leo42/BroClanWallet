...
function ModalsContainer(props){
    ...
    <div className="modalsContainer"> 
        { props.modal === "pendingWallets"  && Object.keys(props.moduleRoot.state.pendingWallets).length > 0   ? <WalletImportModal setOpenModal={() => props.moduleRoot.showModal()} root={props.root} /> : "" }
