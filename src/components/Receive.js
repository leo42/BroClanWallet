...
function Receive(props){
    ...
    useEffect(() => {
            ...
            options.includes( props.wallet.getAddress(donationAddress)) in options ? "" : options.push(props.wallet.getAddress(donationAddress))
            props.wallet.getAddress(donationAddress) in optionsNames ? "" : optionsNames[props.wallet.getAddress(donationAddress)] = "Donate rewards" 
        
            
        
        
            options.push("new")
            optionsNames["new"] = "New Staked Address"
            setOptions(options)
